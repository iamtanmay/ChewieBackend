...
namespace RootMotion.Demos {
	...
	public class CharacterThirdPerson : CharacterBase {
		...
		public FlexibleBehaviourInput_Puppet userControl; // user input
        ...
        public Vector3 moveDirection; // The current move direction of the character in Strafe move mode
        public Animator animator;
        public Vector3 normal, platformVelocity, platformAngularVelocity;
		public RaycastHit hit;
		public float jumpLeg, jumpEndTime, forwardMlp, groundDistance, lastAirTime, stickyForce;
		...
		public Quaternion fixedDeltaRotation = Quaternion.identity;
		...
		private void MoveFixed(Vector3 deltaPosition) {
            ...
            Vector3 velocity = userControl.state.move;// * deltaPosition / Time.deltaTime;
