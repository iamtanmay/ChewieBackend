...
public class CraftCharacterController : MonoBehaviour
{
    ...
    //public FlexibleBehaviourInput_Interact m_eyes;
    ...
    //    foreach (string item in m_inventory.m_prefabsWithReceipt) //loop all craftable items
    //    {
    ...
    //        foreach (string element in item.m_receiptItems)//loop all ingredients for craft current item
    //        {
